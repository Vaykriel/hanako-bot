...
if (msg.content.startsWith(prefix+'avatar')){
	...
	.addField(prefix+'cmd / '+prefix+'help', 'Menampilkan pesan ini. \n', true)
	.addField(prefix+'say', 'Bot akan mengirim pesan berdasarkan input user. \n', true)
	.addField(prefix+'avatar', 'Bot akan mengirim foto profil / Avatar pengirim pesan , mention seseorang untuk membuat Bot mengambil Avatarnya. \n', true)
	.addField(prefix+'cat', 'Bot akan mengirim gambar kucing secara acak.\n', true)
	.addField(prefix+'dog', 'Bot akan mengirim gambar anjing secara acak.\n', true)
	.addField(prefix+'bird', 'Bot akan mengirim gambar burung secara acak.\n', true)
	.addField(prefix+'pat', 'Bot akan mengirim GIF Headpat secara acak.(User harus Mention seseorang agar perintah ini bekerja) \n', true)
	.addField(prefix+'hug', 'Bot akan mengirim GIF Peluk secara acak.(User harus Mention seseorang agar perintah ini bekerja)\n', true)
	.addField(prefix+'play', 'Bot akan memutar lagu sesuai input user.Parameter dapat berupa link video langsung maupun Judul lagu.\n', true)
	.addField(prefix+'pause', 'Bot akan menghentikan lagu sementara.\n', true)
	.addField(prefix+'stop', 'Bot akan menghentikan lagu.\n', true)
	.addField(prefix+'queue', 'Menampilkan antrian lagu.\n', true)
	.addField(prefix+'np', 'Menampilkan judul lagu yang sedang dimainkan.\n', true)
	.addField(prefix+'lyrics', 'Bot akan mengambil lirik lagu sesuai input user.(Sementara ini lirik terbatas pada 1024 karakter)\n', true)
